...
@if ($booking->count())
    <div class="portlet box green">
        ...
        <div class="portlet-body">
                    ...
                    @foreach ($booking as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("quickadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array(config('quickadmin.route').'.booking.destroy', $row->id))) !!}
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.booking.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
